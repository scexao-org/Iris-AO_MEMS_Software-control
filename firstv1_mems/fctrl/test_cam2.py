...
## Set camera 2
#######################################
error = dll.SetCurrentCamera(camera_handle2)
## Get camera 2
c_current_handle = c_long()
error = dll.GetCurrentCamera(byref(c_current_handle))
current_handle2 = c_current_handle.value
print('Current handle 2 :'+str(current_handle2))
...
camera_serialnumber2 = c_number.value
print('Current Serial Number : '+str(camera_serialnumber2))
